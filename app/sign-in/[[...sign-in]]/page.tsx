...
// Sign-in page is ALWAYS dark — hardcoded values, no dark: classes, no CSS variable references.
// This ensures it renders correctly regardless of the html class during client-side navigation.
