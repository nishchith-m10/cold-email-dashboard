  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-border bg-surface overflow-hidden">
        ...
        <div className="px-4 sm:px-6 py-3 border-b border-border bg-surface-elevated/10 flex items-center gap-2">
        ...
        {/* Workspace Name */}
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between px-4 sm:px-6 py-4 border-b border-border gap-3 sm:gap-6">
          ...
          <div className="w-full sm:shrink-0 sm:w-64">
            <Input
              value={workspaceName}
        ...
        {/* Currency */}
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between px-4 sm:px-6 py-4 gap-3 sm:gap-6">
          <div className="min-w-0 sm:flex-1">
