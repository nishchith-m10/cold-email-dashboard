          ...
          {!hasData ? (
            <div className="flex items-center justify-center h-64">
              <div className="text-center space-y-1.5">
                <p className="text-sm text-text-primary/50">No data yet</p>
                <p className="text-xs text-text-secondary/40">
                  {title.includes('Provider')
                    ? 'Usage will appear once your campaigns start running'
                    : 'Model breakdown appears as your campaigns generate data'}
                </p>
              </div>
            </div>
          ) : (
