      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full p-4 bg-surface-elevated border-2 border-border hover:border-accent-primary rounded-lg text-left transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <div className="flex items-start gap-3">
          ...
          <button
            ...
            className="w-full p-4 bg-gradient-to-r from-accent-purple/10 to-accent-primary/10 border-2 border-accent-purple/20 hover:border-accent-purple rounded-lg text-left transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <div className="flex items-start gap-3">
        ...
        <button
          onClick={handleSkip}
          className="w-full h-11 border-2 border-border text-text-secondary rounded-lg font-medium hover:text-text-primary hover:border-border-hover transition-all"
        >
      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="h-11 px-4 border-2 border-border text-text-secondary rounded-lg font-medium hover:text-text-primary hover:border-border-hover transition-all"
          >
            Back
          </button>
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 h-11 bg-accent-primary text-white rounded-lg font-semibold hover:bg-accent-primary/90 transition-colors disabled:opacity-50"
          >
            {isVerifying ? (
              <>
    ...
    return (
      <div className="space-y-6">
        ...
        <button
          ...
          className="w-full h-11 bg-accent-primary text-white rounded-lg font-semibold hover:bg-accent-primary/90 transition-colors"
        >
